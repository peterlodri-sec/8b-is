...
- [graph-and-network-theory-foundations.md](graph-and-network-theory-foundations.md) — Benjamin (2025) + Estrada (Strathclyde): the field absorbed — ER graphs, centrality, communities, communicability, consensus, epidemics — with the full engine-transfer table (UltraGraph speaks its language)
